import { 
    LOADING_TO_REGISTER, SUCCESS_REGISTER, ERROR_REGISTER, 
    LOGIN_SUCCESS, LOGIN_ERROR, LOGIN_LOADING, 
    LOGOUT_START, LOGOUT_ERROR, LOGOUT_SUCCESS, CHECK_AUTHED } from "../actionTypes";

import { 
    registerError, registerStart, registerSuccess, 
    loginSuccess, loginStart, loginError, 
    logoutSuccess, logoutStart, logoutError, 
    checkAuthed } from "../actions";
